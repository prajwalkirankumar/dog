...
<body onload="onload()">
  ...
  <a href=#cart><img id="cart" src="cart.png"></img></a>
...
<div class="bar">
  <div class="foldout" style="float:right;">
    ...
    <div class="fold-content">
      ...
      <input type="radio" name="foo" id="Food" onclick="oncheck(this.id)">Food</input>
      <input type="radio" name="foo" id="Apparels" onclick="oncheck(this.id)">Apparels</input>
      <input type="radio" name="foo" id="Accessory" onclick="oncheck(this.id)">Accessories</input>
      <input type="radio" name="foo" id="Collars" onclick="oncheck(this.id)">Collars</input>
      <input type="radio" name="foo" id="Toy" onclick="oncheck(this.id)">Toys</input>
      <input type="radio" name="foo" id="Medicines" onclick="oncheck(this.id)">Medicines</input></form>
